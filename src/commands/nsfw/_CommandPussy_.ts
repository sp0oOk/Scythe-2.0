...
export const _CommandPussy_: PCommand = {
    category: "NSFW",
    aliases: [],
    ...
    data: new SlashCommandBuilder()
        .setName("pussy")
        .setDescription("Returns a lewd NSFW picture involving pussy!"),
    execute: async (client: Client, interaction: CommandInteraction | any) => {
        ...
        got("https://nekobot.xyz/api/image?type=pussy").then(response => {
