...
export const _CommandHboobs_: PCommand = {
    category: "NSFW",
    aliases: [],
    ...
    data: new SlashCommandBuilder()
        .setName("hboobs")
        .setDescription("Returns a lewd NSFW picture involving hboobs!"),
    execute: async (client: Client, interaction: CommandInteraction | any) => {
        ...
        got("https://nekobot.xyz/api/image?type=hboobs").then(response => {
