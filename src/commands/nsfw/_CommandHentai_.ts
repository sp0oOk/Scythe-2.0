...
export const _CommandHentai_: PCommand = {
    category: "NSFW",
    aliases: [],
    ...
    data: new SlashCommandBuilder()
        .setName("hentai")
        .setDescription("Returns a lewd NSFW picture involving hentai!"),
    execute: async (client: Client, interaction: CommandInteraction | any) => {
        ...
        got("https://nekobot.xyz/api/image?type=hentai").then(response => {
