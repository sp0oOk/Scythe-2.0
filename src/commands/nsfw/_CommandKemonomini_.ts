...
export const _CommandKemonomini_: PCommand = {
    category: "NSFW",
    aliases: [],
    ...
    data: new SlashCommandBuilder()
        .setName("kemonomini")
        .setDescription("Returns a lewd NSFW picture involving kemonomini!"),
    execute: async (client: Client, interaction: CommandInteraction | any) => {
        ...
        got("https://nekobot.xyz/api/image?type=kemonomini").then(response => {
